...
def train(model: Transformer, song_batches, ntoken):
    ...
    for epoch in range(1, EPOCHS):  
        ...
        if epoch % 100 == 0:
            torch.save(model, MODEL_OUTPUT_FOLDER + str(epoch) + "_epochs.pth")
    ...
    # Save model
    torch.save(model, MODEL_OUTPUT_FOLDER + str(EPOCHS) + "_epochs.pth")
